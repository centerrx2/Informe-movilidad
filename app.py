...
def compute_rot_cadera(tree_cadera):
    # ================= DERECHA =================
    R_seg = tree_cadera["sensorData"][10]["orientation"]
    ...
    # ================= IZQUIERDA =================
    L_seg = tree_cadera["sensorData"][13]["orientation"]
...
def compute_thomas(tree_d, tree_i, start_frame=0, debug_plot=True):
    ...
    # ===================== DERECHA =====================
    # ✅ MATLAB: sensor 10
    q_R_thigh = tree_d["sensorData"][9]["orientation"]  # [qw qx qy qz]
    ...
    # ===================== IZQUIERDA =====================
    # ✅ MATLAB: sensor 13
    q_L_thigh = tree_i["sensorData"][12]["orientation"]
